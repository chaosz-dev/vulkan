...
void LightningPass::BuildPipeline(
    ...
    // Simple lightning
    {
        ...
        m_simplePipeline = CreatePipeline(device, surfaceExtent, renderPass, pipelineLayout, gridShaders[0], gridShaders[1]);
    ...
    // shadow map lightning
    {
        ...
        m_shadowMapPipeline = CreatePipeline(device, surfaceExtent, renderPass, pipelineLayout, gridShaders[0], gridShaders[1]);
