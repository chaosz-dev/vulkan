...
public:
  ...
  Mesh(const std::string& filename, const VkPhysicalDevice& phyDevice, const VkDevice& device, glm::vec3 modelPos) {
    ...
    m_bufferInfo = BufferInfo::Create(phyDevice, device, m_vertices.size() * sizeof(float), VK_BUFFER_USAGE_VERTEX_BUFFER_BIT);
