...
int main(int /*argc*/, char ** /*argv*/) {
    ...
    icecream.m_rotation.x = 1;
    icecream.m_rotation.z = 1;
    ...
    while (!glfwWindowShouldClose(window)) {
...

        {
            ...
            ImGui::Checkbox("Rotate icecream (button R)", &icecreamRotation);
            ImGui::Checkbox("Rotate icecream (button T)", &monkeyRotation);
...

        {
            ...
            */
            ...
            {
                // draw donut
                glm::mat4 mvp = projection * view * glm::scale(donut.m_model, glm::vec3(10.0f));
    ...
    icecream.destroyResources(device);
    monkey.destroyResources(device);
    donut.destroyResources(device);
