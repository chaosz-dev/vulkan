...
int main(int /*argc*/, char **/*argv*/) {
    ...
    BufferInfo cubeVertexInfo = CreateBuffer(phyDevice, device, sizeof(cubeVertices), VK_BUFFER_USAGE_VERTEX_BUFFER_BIT);
    ...
    memcpy(GPUPtr, cubeVertices, sizeof(cubeVertices));
