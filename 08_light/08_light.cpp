...
int main(int /*argc*/, char **/*argv*/) {
    ...
    VkPipeline cubeNoDepthPipeline = CreateSimpleVec3Pipeline(device, surfaceExtent, renderPass, trianglePipelineLayout, shaderVertex, shaderFragment, false, true);
    VkPipeline cubeDepthPipeline = CreateSimpleVec3Pipeline(device, surfaceExtent, renderPass, trianglePipelineLayout, shaderVertex, shaderFragment, true, true);
    ...
    glm::vec4 lightPos    = glm::vec4(1.2f, 1.0f, 2.0f, 1.0f);
    ...
    while (!glfwWindowShouldClose(window)) {
...

        {
            ...
            if (glfwGetKey(window, GLFW_KEY_LEFT) == GLFW_PRESS) {
                lightPos.x -= cameraSpeed / 2;
            } else if (glfwGetKey(window, GLFW_KEY_RIGHT) == GLFW_PRESS) {
                lightPos.x += cameraSpeed / 2;
            } else if (glfwGetKey(window, GLFW_KEY_UP) == GLFW_PRESS) {
                lightPos.z -= cameraSpeed / 2;
...

        {
            ...
            */
            ...
            vkCmdPushConstants(cmdBuffer, trianglePipelineLayout, pushFlags, 3 * sizeof(MVP) + sizeof(glm::vec4), sizeof(lightPos), &lightPos);
            ...
            {   // our main cube
                ...
                vkCmdPushConstants(cmdBuffer, trianglePipelineLayout, pushFlags, 1 * sizeof(MVP), sizeof(MVP), &view);
                vkCmdPushConstants(cmdBuffer, trianglePipelineLayout, pushFlags, 2 * sizeof(MVP), sizeof(MVP), &projection);
                vkCmdPushConstants(cmdBuffer, trianglePipelineLayout, pushFlags, 3 * sizeof(MVP), sizeof(cameraPos), &cameraPos);
